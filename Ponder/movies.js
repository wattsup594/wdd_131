...
const movies = [
    ...
    let html = `
                ...
                <p><strong>Release Date:</strong> ${item.date}</
                p>
                <p><strong>Recommended Age:</strong> ${item.ages}
                </p>
                <p><strong>Genre:</strong> ${item.genre}</p>
                <p><strong>Rating:</strong> <span aria-label="${item.stars.length}
                out of 5 stars" role="img">${item.stars}</span></p>
